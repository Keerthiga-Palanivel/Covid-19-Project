...
############################################################
#Define the dependent variable (Population of people older than 65 years) as x_variable
#Define the independent variable (Total number of deaths) as y_variable
